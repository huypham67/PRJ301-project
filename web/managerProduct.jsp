                ...
                <div class="modal-content">
                    <form action="edit" method="post">
                        ...
                        <div class="modal-body">	
                            <div class="form-group">
                                <label>Id</label>
                                <input value="${p.id}" name="id" type="text" readonly class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>Name</label>
                            ...
                            <div class="form-group">
                                <label>Image</label>
                                <input value="${p.image}" name="image" type="email" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>Price</label>
                                <textarea name="price" class="form-control" required>${p.price}</textarea>
                            </div>
                            <div class="form-group">
                                <label>Title</label>
