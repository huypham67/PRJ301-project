            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdown1">
                    <c:forEach items="${listC}" var="o">
                        <li class="dropdown-item" href="#"><a href="category?cid=${o.cid}">${o.cname}</a></li>
                    </c:forEach>
                </ul>
            </li>
            <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdown1"> 
                            ...
                            <li class="dropdown-item dropdown">
                                <a class="dropdown-toggle" id="dropdown2-1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Language</a>
                                <ul class="dropdown-menu" aria-labelledby="dropdown1-1">
                                    <li class="dropdown-item" href="#"><a>English</a></li>
                                    <li class="dropdown-item" href="#"><a>Vietnamese</a></li>
                                </ul>
                            </li>
